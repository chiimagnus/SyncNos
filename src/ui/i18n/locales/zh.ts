...
export const zh: { [K in TranslationKey]: string } = {
  ...
  section_github_desc: '通过 SyncNos GitHub App 单向同步 Markdown。',
  ...
  githubSettingsTitle: 'GitHub Markdown 同步',
  ...
  githubOneWayNotice: '单向输出：SyncNos 始终是本地事实源。手动 reconcile 可能覆盖直接在 GitHub 上修改的受管 Markdown 文件。',
