...
export const zh: { [K in TranslationKey]: string } = {
  ...
  webArticleCacheImagesHint: '仅影响网页文章。采集时会下载图片，避免云链接失效。',
  xiaohongshuCommentsHeading: '小红书笔记',
  xiaohongshuCommentsLabel: '采集源站评论区',
  xiaohongshuCommentsHint: '关闭时仅采集正文；开启后保存当前页面已加载、已展开的评论和回复。',
  antiHotlinkRulesLabel: '防盗链域名',
  antiHotlinkRulesHint: '添加 CDN 域名与 Referer URL。命中后即使关闭自动保存图片，也会在采集网页文章时自动缓存。',
