...
export const zh: { [K in TranslationKey]: string } = {
  ...
  section_notion_desc: '连接与同步设置。',
  section_feishu_label: '飞书',
  section_feishu_desc: '连接与同步设置。',
  section_obsidian_label: 'Obsidian',
  section_obsidian_desc: '连接与同步设置。',
  section_github_label: 'GitHub',
  section_github_desc: '连接与同步设置。',
  ...
  insightTopCommentedClipsTitle: '🏆 Top 3 最多评论数',
  ...
  githubSyncEnabledLabel: '同步到 GitHub',
  githubAutoSyncEnabledLabel: '自动同步',
  githubConnect: '连接 GitHub',
  githubDeviceCodeLabel: '临时代码',
  githubDeviceInstruction: '只在 GitHub 官方设备授权页面输入此代码，不要把代码分享给任何人。',
  githubDeviceExpiresAt: '代码过期时间',
  githubOpenDevicePage: '打开 GitHub',
  githubCancelDeviceFlow: '取消',
  githubConnectedAs: '已连接账号',
  githubConnected: '已连接',
  githubDisconnectLocalNote: '断开连接只会清除此设备上的 GitHub 凭据；repository 与目录偏好会保留。',
  githubRevokeHint: '如需彻底撤销授权，请前往 GitHub Settings → Applications → Authorized GitHub Apps → Revoke。GitHub App 的 installation/repository 访问范围需在 Installed GitHub Apps 中单独管理。',
  githubOneWayNotice: '单向输出：SyncNos 始终是本地事实源。手动 reconcile 可能覆盖直接在 GitHub 上修改的受管文件。',
  githubRepositoryLabel: 'Repository',
  githubRepositoryPlaceholder: '选择已授权的 repository',
  githubRepositoryUnavailable: '不可用',
  githubRepositoryReadOnly: '无写入权限',
  githubRefreshRepositories: '刷新 repositories',
  githubInstallOrConfigureApp: '安装 / 配置 GitHub App',
  githubInstallRequired: '请为目标 repository 所属的账号或组织安装 SyncNos GitHub App。',
  githubNoAccessibleRepositories: 'SyncNos GitHub App 当前没有可访问的 repository。',
  githubTargetUnavailableHint: '已保存的 repository 当前不可访问。配置已原样保留；请选择其他已授权 repository，或恢复 GitHub App 的访问权限。',
  githubBranchLabel: 'Branch',
  githubSaveTarget: '保存目标',
  githubTestConnection: '测试连接',
  githubInitializeRepository: '初始化 repository',
  githubInitializingRepository: '正在初始化 repository…',
  githubRepositoryUninitializedHint: '这个 repository 还是空的。初始化后会创建 README.md 和第一个 commit。',
