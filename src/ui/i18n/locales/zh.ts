...
export const zh: { [K in TranslationKey]: string } = {
  ...
  localDatabaseMigrationInProgressBody: '迁移尚未结束；在到达经过验证的终态前，新的事实操作会保持阻塞。',
  localDatabaseResumeBody: '迁移停在可恢复的持久化阶段，可以安全继续。',
