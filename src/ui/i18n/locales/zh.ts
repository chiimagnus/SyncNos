...
export const zh: { [K in TranslationKey]: string } = {
  ...
  section_cli_desc: '本地 CLI 集成与 AI Agent Skill 安装。',
  section_articles_label: '网页采集',
  section_articles_desc: '网页采集设置与支持范围。',
  ...
  cliSkillInstallPrefix: '将',
  cliSkillInstallOr: '或',
  cliSkillInstallSuffix: '复制到',
  cliSkillInstallEnd: '，然后重启 Codex。',
  cliSkillChineseLink: '中文 Skill',
  ...
  articlesSectionSupportedGeneral: '大多数 http(s) 网页',
  articlesSectionSupportedEnhancedPrefix: '增强适配：',
  articlesSectionSupportedEnhancedSuffix: '。',
  aiChatsSectionHeading: 'AI 对话采集',
  aiChatsSectionSupportedHeading: '支持范围',
  aiChatsSectionSupportedListPrefix: '支持：',
  ...
  chatgptApiCaptureAdvancedHint: '默认关闭；仅手动保存 ChatGPT 时使用当前登录 Session，失败不会在同一次保存中回退 DOM。',
