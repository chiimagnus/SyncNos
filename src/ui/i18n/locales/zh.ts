...
export const zh: { [K in TranslationKey]: string } = {
  ...
  section_feishu_label: '飞书',
  section_feishu_desc: 'OAuth 授权 + DocX 同步。',
  section_obsidian_label: 'Obsidian',
  section_obsidian_desc: '本地 REST API 设置 + 同步状态。',
  section_chat_with_label: '与 AI 对话',
  section_chat_with_desc: 'Prompt 模板与平台。',
  section_aboutyou_label: '数据概览',
  ...
  section_ai_chats_desc: '支持平台与抓取教程。',
  section_videos_label: '视频字幕抓取',
  section_videos_desc: '支持范围与抓取教程。',
  section_inpage_label: '通用',
  section_inpage_desc: '页面内按钮显示与自动保存设置。',
  section_aboutme_label: '关于',
  ...
  articlesSectionSupportedGeneral: '大多数 http(s) 网页都可尝试抓取。',
  articlesSectionSupportedEnhancedPrefix: '对部分站点有增强适配（不保证覆盖所有页面）：',
  articlesSectionSupportedEnhancedSuffix: '。',
  articlesSectionHowToHeading: '如何抓取',
  articlesSectionHowToStep1: '打开一篇文章页面。',
  articlesSectionHowToStep2Prefix: '点击抓取按钮中的 ',
  articlesSectionHowToStep2Suffix: '。',
  articlesSectionHowToStep3Prefix: '或右键页面 → SyncNos → ',
  articlesSectionHowToStep3Suffix: '。',
  articlesSectionHowToStep4: '等待页面提示“已保存/已更新”。',
  articlesSectionTroubleshootingHeading: '常见问题',
  articlesSectionTroubleshootingUnsupported: '如果显示“不可用”，说明当前页面暂不支持抓取。',
  articlesSectionTroubleshootingDynamic: '部分高度动态/反爬页面可能只能抓到部分内容；可刷新后重试。',
  aiChatsSectionHeading: 'AI 对话采集',
  aiChatsSectionIntro: '将当前对话线程保存为一条会话（对话/消息）。',
  ...
  aiChatsSectionHowToStep2Suffix: '。',
  aiChatsSectionHowToStep3Prefix: '或右键页面 → SyncNos → ',
  aiChatsSectionHowToStep3Suffix: '。',
  aiChatsSectionHowToStep4: '如已开启自动保存，后续新消息会自动尝试保存。',
  aiChatsSectionTroubleshootingHeading: '常见问题',
  aiChatsSectionTroubleshootingNoVisibleConversation:
    '如果提示“未找到可见对话”，请先滚动加载历史或切换到正确的线程后再抓取。',
  aiChatsSectionTroubleshootingAutoSavePrefix: '自动保存开关在通用设置中的 ',
  aiChatsSectionTroubleshootingAutoSaveSuffix: '。',
  videosSectionHeading: '视频字幕采集',
  videosSectionIntro: '采集页面已加载的 YouTube / Bilibili 字幕（不会下载视频）。',
  videosSectionSupportedHeading: '支持范围',
  ...
  videosSectionSupportedBilibiliSuffix: ' 视频页；支持 UP 主字幕与 AI 字幕。',
  videosSectionHowToHeading: '如何抓取',
  videosSectionHowToStep1: '打开视频页面，并在播放器内开启字幕/CC。',
  videosSectionHowToStep2: '切换到你想要的字幕轨道/语言（B 站 AI 字幕需要在字幕菜单里选择 AI 字幕轨道）。',
  videosSectionHowToStep3: '等待字幕出现（建议播放 2–3 秒）。',
  videosSectionHowToStep4: '在页面空白处右键 → SyncNos → 保存视频字幕。',
  videosSectionTroubleshootingHeading: '常见问题',
  videosSectionTroubleshootingNoSubtitles:
    '如果提示“未检测到字幕，未保存”，通常是字幕还没加载；请先开启字幕/切换轨道后重试（必要时刷新页面）。',
  videosSectionTroubleshootingUnsupported: '仅支持上面列出的 URL 类型（例如 YouTube Shorts 目前不支持）。',
  ...
  readerNarrationButton: '朗读',
  readerNarrationPlay: '朗读',
  readerNarrationReading: '朗读中…',
  readerNarrationPause: '暂停',
  readerNarrationStop: '停止',
  readerTextPreset: '预设',
  readerTextFont: '字体',
  readerFontAria: '阅读字体',
  readerFontSerif: '衬线',
  readerFontSans: '无衬线',
  readerFontMono: '等宽',
  readerTextAlignment: '对齐',
  readerAlignAria: '阅读文本对齐',
  readerAlignLeft: '左对齐',
  readerAlignJustify: '两端对齐',
  readerTextFontSize: '字号',
  readerFontSizeAria: '阅读字号',
  readerTextLineHeight: '行高',
  readerLineHeightAria: '阅读行高',
  readerTextContentWidth: '正文宽度',
  readerContentWidthAria: '阅读正文宽度',
  readerTextLetterSpacing: '字间距',
  readerLetterSpacingAria: '阅读字间距',
  readerThemeLabel: '主题',
  readerThemeAria: '阅读主题',
  readerThemeSystem: '跟随系统',
  readerThemeLight: '浅色',
  readerThemeSepia: '护眼',
  readerThemeDark: '深色',
  readerThemeBlack: '纯黑',
  readerNarrationFallback: '回退到 Web Speech',
  readerNarrationEngine: '引擎',
  readerNarrationEngineAria: '朗读引擎',
  readerEngineWeb: 'Web Speech',
  readerEngineAi: 'AI 端点',
  readerNarrationSpeed: '语速',
  readerNarrationSpeedAria: '朗读语速',
  readerNarrationVoice: '声音',
  readerNarrationVoiceAria: 'Web Speech 声音',
  readerVoiceSystemDefault: '系统默认',
  readerNarrationEndpoint: '端点',
  readerNarrationEndpointAria: 'AI 朗读端点',
  readerNarrationApiKey: 'API 密钥',
  readerNarrationApiKeyAria: 'AI 朗读 API 密钥',
  readerNarrationModel: '模型',
  readerNarrationModelAria: 'AI 朗读模型',
  readerNarrationAiVoiceAria: 'AI 朗读声音',
  readerNarrationFormat: '音频格式',
  readerNarrationFormatAria: 'AI 朗读音频格式',
  ...
  xiaohongshuCommentsLabel: '采集源站评论区',
  xiaohongshuCommentsHint: '仅保存当前已加载、已展开的评论和回复。',
  antiHotlinkRulesLabel: '防盗链域名',
  antiHotlinkRulesHint: '添加 CDN 域名与 Referer；命中后强制缓存图片。',
  antiHotlinkDomainLabel: '域名',
  ...
  localDatabaseCardTitle: '本地数据库',
  localDatabaseCardSubtitle: '将抓取事实存储到由 SyncNos 管理的 SQLite 数据库。',
  localDatabaseChecking: '检测中…',
  localDatabaseSetupRequiredTitle: '可以启用',
  localDatabaseSetupRequiredBody: '当前浏览器 Profile 仍在使用自己的 IndexedDB 事实数据。',
  localDatabaseJoinRequiredTitle: '加入已有本地数据库',
  localDatabaseJoinRequiredBody: '检测到健康的共享 SQLite 数据库。当前浏览器 Profile 必须显式确认加入后才能使用本地数据库。',
  localDatabaseMigrationInProgressTitle: '迁移进行中',
  localDatabaseMigrationInProgressBody: '迁移正在自动执行；完成或失败后会进入明确的终态。',
  localDatabaseMigrationFailedTitle: '迁移失败',
  localDatabaseMigrationFailedBody: '迁移已停止。重新迁移会从可安全验证的边界继续处理；如果 SQLite 尚未提交，则从源事实重新迁移；如果已经提交，则只完成必要的验证与收尾。',
  localDatabaseMigrationUnavailableBody: '当前会话事实暂时不可用。请前往设置 → 备份 → 本地数据库查看失败原因并重新迁移。',
  localDatabaseActiveTitle: '本地数据库已启用',
  localDatabaseActiveBody: '当前浏览器 Profile 正在使用共享本地数据库。',
  localDatabaseFixedLocationBody: '数据库位于由 CLI 管理的 SyncNos 固定应用数据位置。',
  localDatabaseBlockedTitle: '本地数据库迁移已阻塞',
  localDatabaseBlockedBody: '迁移日志或验证状态被阻塞。继续操作前请重新检测状态。',
  localDatabaseUnavailableTitle: '本地数据库不可用',
  localDatabaseUnavailableBody: '当前浏览器 Profile 无法使用本地数据库 Host。',
  localDatabaseSafariUnsupportedTitle: 'Safari 不支持本地数据库',
  localDatabaseSafariUnsupportedBody: 'Safari 不支持 SyncNos 本地数据库模式。',
  localDatabaseEnableAction: '启用本地数据库',
  localDatabaseJoinAction: '加入已有数据库',
  localDatabaseRetryAction: '重新迁移',
  localDatabaseRecheckAction: '重新检测',
  localDatabaseMigrationWorking: '处理中…',
  localDatabaseDiagnostics: '本地数据库诊断',
  localDatabaseStatusLoadFailed: '无法检测本地数据库状态。',
  localDatabaseActionFailed: '本地数据库迁移失败。',
  localDatabaseEnableDialogTitle: '启用本地数据库？',
  localDatabaseJoinDialogTitle: '加入已有本地数据库？',
  localDatabaseRetryDialogTitle: '重新迁移本地数据库？',
  localDatabaseEnableDialogIntro: '开始迁移当前浏览器 Profile 前，请确认以下事项。',
  localDatabaseJoinDialogIntro: '当前浏览器 Profile 会把自己的抓取事实加入已有的共享数据库。',
  localDatabaseRetryDialogIntro: '上一次迁移已经失败。重新迁移会重新校验源事实；如果 SQLite 已经提交，则只完成必要的提交确认与浏览器侧收尾。',
  localDatabaseMigrationFactsNotice: '会迁移五类抓取事实：对话、映射、消息、图片缓存和文章评论。',
  localDatabaseMigrationCleanupNotice: '只有 SQLite 回执与验证都成功后，才会清理当前浏览器 Profile 的 IndexedDB 事实副本。',
  localDatabaseMigrationNoRollbackNotice: '本地数据库进入 active 后，不提供切回 IndexedDB 的开关。',
  localDatabaseMigrationSettingsNotice: '浏览器设置与 OAuth 凭据仍只保存在当前浏览器 Profile，不会通过 SQLite 共享。',
  localDatabaseJoinMergeNotice: '加入时只做保守合并：不会覆盖已有 SQLite 事实；验证成功后也只清理当前 Profile 的 IndexedDB 事实。',
  localDatabaseConfirmEnable: '启用本地数据库',
  localDatabaseConfirmJoin: '加入已有数据库',
  localDatabaseCloseDialog: '关闭本地数据库确认窗口',
  localDatabaseInstallHelpTitle: '本地数据库安装帮助',
  ...
  localDatabaseAiPromptLabel: '给 AI 助手的提示词',
  localDatabaseDoctorCommandLabel: '注册修复命令',
  localDatabaseDoctorScopeHelp: 'doctor --fix 只修复可证明属于 SyncNos 的注册与受支持的 owner-only 文件权限；无法证明所有权时会拒绝操作，不会删除数据库，也不会绕过浏览器 allowlist 或突破操作系统沙盒。',
  localDatabaseNodeRequirementHelp: 'SyncNos CLI 需要 Node.js 22 或更高版本。记录的 Node 运行时缺失或过旧会让 Native Host 不可达；请先在受支持的 Node 运行时下重新安装/更新 CLI，再运行 doctor。',
  localDatabaseLinuxSandboxHelp: 'Linux：如果 Chrome/Chromium 来自严格 Snap 或 Flatpak 沙盒，Native Messaging 路径可能被沙盒阻断。doctor --fix 不能突破该沙盒；若注册始终不可达，请使用受支持的非严格沙盒浏览器包。',
  localDatabaseSafariNoInstallHelp: 'Safari 没有本地数据库操作。安装或修复 CLI 也不会在 Safari 中启用本地数据库。',
  localDatabaseDevelopmentIdentityHelp: '当前扩展身份不在官方 Native Host allowlist 中。开发版或侧载身份不能生成注册绕过路径。',
  localDatabaseCopyAction: '复制',
  localDatabaseCopied: '已复制',
  localDatabaseCopyFailed: '无法复制本地数据库安装文本。',
  ...
  notionAdvancedDbIdHint: '可选；留空则自动发现或创建。',
  ...
  warningBadge: '警告',
  warningFlagUnknownPrefix: '未知警告',
  warningFlagInlineImagesFetchUnavailable: '当前环境不支持图片抓取',
  warningFlagInlineImagesFetchFailed: '抓取图片失败',
  warningFlagInlineImagesDownloadFailed: '下载一张或多张图片失败',
  warningFlagInlineImagesNonImageBlob: '检测到非图片 Blob 资源',
  warningFlagInlineImagesEmptyBlob: '图片 Blob 为空',
  warningFlagInlineImagesEncodeFailed: '图片编码失败，无法内联保存',
  warningFlagDiscourseOpMissingOnPage: '当前页面未找到楼主正文（OP）',
  warningFlagContainerLowConfidence: '内容容器识别置信度较低',
  skipped: '跳过',
  deleteButton: '删除',
  ...
  tooltipSyncProvidersDisabledDetailed: '同步目标已关闭，请先在设置里启用同步选项',
  paginationLoadingMore: '正在加载更多...',
  ...
  localSearchOpen: '搜索',
  localSearchOpenAria: '搜索本地会话',
  localSearchDialogAria: '本地会话搜索',
  localSearchCloseAria: '关闭本地搜索',
  localSearchCapabilityLoading: '正在检查本地数据库…',
  localSearchQueryAria: '搜索关键词',
  localSearchQueryPlaceholder: '搜索已保存的会话',
  localSearchSearchAction: '搜索',
  localSearchSourceFilterAria: '搜索来源筛选',
  localSearchSiteFilterAria: '搜索站点筛选',
  localSearchSortAria: '搜索排序方式',
  localSearchSortBest: '最佳匹配',
  localSearchSortRecent: '最近更新',
  localSearchNoQuery: '输入关键词后按 Enter 或点击“搜索”。',
  localSearchSearching: '正在搜索本地会话…',
  localSearchEmpty: '没有匹配该关键词的本地会话。',
  localSearchResultsAria: '本地搜索结果',
  localSearchLoadMore: '加载更多',
  localSearchLoadingMore: '正在加载更多…',
  localSearchCursorStale: '本地数据库已变化，请重新提交搜索后再继续分页。',
  localSearchTruncated: '为保持搜索响应速度，本次结果已限制扫描范围。',
  localSearchPreviewAria: '搜索结果预览',
  localSearchPreviewHint: '选择一条结果以加载完整的本地会话。',
  localSearchPreviewLoading: '正在加载完整会话…',
  localSearchOpenConversation: '打开完整会话',
  localSearchDisabledTitle: '本地搜索需要启用本地数据库',
  localSearchDisabledBody: '请在“备份”设置中启用本地数据库后再搜索；不会回退扫描 IndexedDB。',
  localSearchOpenLocalDatabaseSettings: '打开本地数据库设置',
  localSearchFtsUnavailable: '当前本地数据库无法使用全文搜索。',
  localSearchMigrationBusy: '本地数据库正在迁移，完成后即可搜索。',
  localSearchMigrationFailed: '本地数据库迁移已停止，请前往本地数据库设置处理后重新迁移。',
  localSearchHostUnavailable: '本地数据库 Host 当前不可用，请检查本地数据库设置后重试。',
  localSearchGenericError: '本地搜索失败，请重试。',
  ...
  chatWithSectionSubtitle: '生成内容会复制到剪贴板，并打开所选 AI 平台。',
  ...
  feishuPaths: '飞书路径',
  feishuPathsNote: '相对云盘根目录；留空使用默认路径。',
