export const en = {
  ...
  section_videos_label: 'Video capture',
  section_videos_desc: 'Supported video pages + how-to.',
  ...
  localCliIntegrationHeading: 'Local CLI Integration',
  localCliIntegrationLabel: 'Enable SyncNos CLI',
  localCliIntegrationHint: 'Allows the local syncnos command to use this browser profile while the browser is running.',
  localCliIntegrationUnavailable: 'Native Messaging is unavailable in this browser.',
  ...
  videosSectionHeading: 'Video capture',
  videosSectionIntro:
    'Save available context from supported YouTube/Bilibili video pages; subtitles are saved when available, and Bilibili player chapters/highlights are saved when provided.',
  ...
  videosSectionHowToStep2:
    'To save subtitles too, turn on captions/CC and choose the track/language you want (for Bilibili AI subtitles, select an AI subtitle track).',
  videosSectionHowToStep3:
    'Save after captions appear to capture them; videos without subtitles can still save available description, chapters, and other context.',
  videosSectionHowToStep4: 'Right click the page → SyncNos → Save video.',
  videosSectionTroubleshootingHeading: 'Troubleshooting',
  videosSectionTroubleshootingNoSubtitles:
    'If you see “No subtitles detected; available video details were saved.”, this capture had no trustworthy subtitles. Available description, chapters, and other video context are still saved; capture again after subtitles load to add or update them.',
  ...
  tooltipExportDetailed: 'Export selected content',
  tooltipExportSelectFirstDetailed: 'Select content first, then export',
  ...
  insightOverviewVideoCount: '🎬 Videos',
  ...
  insightVideosSectionAria: 'Videos',
  insightVideosSectionTitle: '🎬 Videos',
