export const en = {
  ...
  section_notion_desc: 'Connection and sync settings.',
  section_feishu_label: 'Feishu',
  section_feishu_desc: 'Connection and sync settings.',
  section_obsidian_label: 'Obsidian',
  section_obsidian_desc: 'Connection and sync settings.',
  section_github_label: 'GitHub',
  section_github_desc: 'Connection and sync settings.',
  ...
  openOriginalChat: 'Open original link',
  ...
  insightTopCommentedClipsTitle: '🏆 Top 3 most comments',
  ...
  githubSyncEnabledLabel: 'Sync to GitHub',
  githubAutoSyncEnabledLabel: 'Auto sync',
  githubConnect: 'Connect GitHub',
  githubDeviceCodeLabel: 'Temporary code',
  githubDeviceInstruction: 'Enter this code only on the official GitHub device page. Do not share it with anyone.',
  githubDeviceExpiresAt: 'Code expires at',
  githubOpenDevicePage: 'Open GitHub',
  githubCancelDeviceFlow: 'Cancel',
  githubConnectedAs: 'Connected as',
  githubConnected: 'Connected',
  githubDisconnectLocalNote: 'Disconnect removes GitHub credentials from this device only. Repository and folder preferences are kept.',
  githubRevokeHint: 'To revoke authorization completely, use GitHub Settings → Applications → Authorized GitHub Apps → Revoke. Installation access is managed separately under Installed GitHub Apps.',
  githubOneWayNotice: 'One-way output: SyncNos remains the local source of truth. Manual reconcile can overwrite edits made directly to managed GitHub files.',
  githubRepositoryLabel: 'Repository',
  githubRepositoryPlaceholder: 'Choose an authorized repository',
  githubRepositoryUnavailable: 'Unavailable',
  githubRepositoryReadOnly: 'No write access',
  githubRefreshRepositories: 'Refresh repositories',
  githubInstallOrConfigureApp: 'Install / Configure GitHub App',
  githubInstallRequired: 'Install the SyncNos GitHub App for the account or organization that owns your target repository.',
  githubNoAccessibleRepositories: 'No repositories are currently accessible to the SyncNos GitHub App.',
  githubTargetUnavailableHint: 'The saved repository is no longer accessible. It was kept unchanged; choose another authorized repository or restore GitHub App access.',
  githubBranchLabel: 'Branch',
  githubSaveTarget: 'Save target',
  githubTestConnection: 'Test connection',
  githubInitializeRepository: 'Initialize repository',
  githubInitializingRepository: 'Initializing repository…',
  githubRepositoryUninitializedHint: 'This repository is empty. Initialize it to create README.md and the first commit.',
