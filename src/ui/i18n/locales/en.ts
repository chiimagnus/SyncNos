export const en = {
  ...
  section_cli_label: 'CLI',
  section_cli_desc: 'Local CLI integration and AI-agent Skill setup.',
  section_articles_label: 'Web capture',
  section_articles_desc: 'Web capture settings and supported pages.',
  ...
  cliSkillHeading: 'AI-agent Skill',
  cliSkillInstallPrefix: 'Copy',
  cliSkillInstallOr: 'or',
  cliSkillInstallSuffix: 'into',
  cliSkillInstallEnd: ', then restart Codex.',
  cliSkillChineseLink: 'Chinese Skill',
  cliSkillEnglishLink: 'English Skill',
  ...
  articlesSectionSupportedGeneral: 'Most http(s) pages',
  articlesSectionSupportedEnhancedPrefix: 'Enhanced:',
  articlesSectionSupportedEnhancedSuffix: '.',
  aiChatsSectionHeading: 'AI chat capture',
  aiChatsSectionSupportedHeading: 'Supported',
  aiChatsSectionSupportedListPrefix: 'Supports:',
  ...
  chatgptApiCaptureAdvancedHint:
    'Off by default; used only for manual ChatGPT saves with your signed-in session, with no same-save DOM fallback on failure.',
