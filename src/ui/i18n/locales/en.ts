export const en = {
  ...
  localDatabaseMigrationInProgressBody: 'Migration is still running. Captured facts stay blocked until it reaches a verified terminal stage.',
  localDatabaseResumeBody: 'Migration stopped at a durable stage and can be resumed safely.',
  ...
  localDatabaseResumeAction: 'Resume Migration',
  localDatabaseRecheckAction: 'Check again',
  localDatabaseMigrationWorking: 'Working…',
  localDatabaseMigrationStage: 'Stage:',
