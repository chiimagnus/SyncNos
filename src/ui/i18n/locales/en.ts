export const en = {
  ...
  section_cli_label: 'CLI & AI SKILL',
  section_cli_desc: 'Local CLI integration and AI SKILL setup.',
  ...
  cliSkillHeading: 'AI SKILL',
  cliSkillInstallHint: 'Choose a Skill below and install it in the Skills directory used by your AI agent.',
