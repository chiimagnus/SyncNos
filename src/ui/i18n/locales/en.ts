export const en = {
  ...
  section_github_desc: 'One-way Markdown sync through the SyncNos GitHub App.',
  ...
  githubSettingsTitle: 'GitHub Markdown Sync',
  ...
  githubOneWayNotice: 'One-way output: SyncNos remains the local source of truth. Manual reconcile can overwrite edits made directly to managed GitHub Markdown files.',
