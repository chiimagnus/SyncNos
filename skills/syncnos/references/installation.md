...
- Use `syncnos install --browser <id>` when the user chose a browser, or automatic discovery missed a confirmed portable/dev/non-standard installation. Current browser ids come from `syncnos --help`.
