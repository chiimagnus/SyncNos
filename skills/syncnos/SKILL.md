---
name: syncnos
description: "Use the SyncNos Web Clipper and its `syncnos` CLI/browser extension to capture, query, and manage content; work with comments and settings; sync providers; open, export, and back up data."
---
