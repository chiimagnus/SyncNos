...
- **Article comment threads** — local threaded comments for web articles (detail + inpage panel); root comment composer auto-attaches current selection as quote (reply composer does not), preserved in Zip v2 backup/restore and article sync flows.
