export const en = {
  ...
  insightChatSectionSubtitle: 'Platform distribution + total message turns + Top 3 longest conversations',
  insightTotalMessagesLabel: 'Total message turns',
