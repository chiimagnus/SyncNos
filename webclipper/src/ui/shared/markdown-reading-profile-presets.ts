...
export const MARKDOWN_READING_PROFILE_PRESETS: Record<MarkdownReadingProfileId, MarkdownReadingProfilePreset> = {
  ...
  book: {
    ...
    typographyClassName: [
      ...
      '[&_p]:tw-max-w-[74ch] [&_li]:tw-max-w-[74ch] [&_blockquote]:tw-max-w-[74ch]',
      '[&_p]:tw-mb-[1.08rem] [&_ul]:tw-mb-[0.9rem] [&_ol]:tw-mb-[0.9rem] [&_blockquote]:tw-mb-[1rem]',
      ...
      '[&_pre>code]:tw-text-[0.86em] [&_pre>code]:tw-leading-[1.6] [&_code]:tw-text-[0.86em] [&_kbd]:tw-text-[0.86em]',
