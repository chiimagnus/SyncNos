...
export function ChatMessageBubble({ role, headerLeft, headerRight, markdown, className }: ChatMessageBubbleProps) {
  ...
  const mdClass =
    [
      ...
      // Notion-like body typography (base 16px, 24px line-height).
      'tw-min-w-0 tw-break-words [overflow-wrap:anywhere] tw-overflow-x-hidden tw-text-[16px] tw-leading-[24px] tw-font-normal',
      '[&>*:first-child]:tw-mt-0 [&>*:last-child]:tw-mb-0',

      '[&_p]:tw-mt-0 [&_p]:tw-mb-3',

      // Notion-like heading scale (base = 16px):
      // H1 30px/39px, H2 24px/31.2px, H3 20px/26px.
      '[&_h1]:tw-mt-6 [&_h1]:tw-mb-2 [&_h1]:tw-text-[30px] [&_h1]:tw-leading-[39px] [&_h1]:tw-font-[600]',
      '[&_h2]:tw-mt-5 [&_h2]:tw-mb-2 [&_h2]:tw-text-[24px] [&_h2]:tw-leading-[31.2px] [&_h2]:tw-font-[600]',
      '[&_h3]:tw-mt-4 [&_h3]:tw-mb-2 [&_h3]:tw-text-[20px] [&_h3]:tw-leading-[26px] [&_h3]:tw-font-[600]',
      '[&_h4]:tw-mt-4 [&_h4]:tw-mb-2 [&_h4]:tw-text-[18px] [&_h4]:tw-leading-[24px] [&_h4]:tw-font-[600]',
      '[&_h5]:tw-mt-4 [&_h5]:tw-mb-2 [&_h5]:tw-text-[16px] [&_h5]:tw-leading-[24px] [&_h5]:tw-font-[600]',
      '[&_h6]:tw-mt-4 [&_h6]:tw-mb-2 [&_h6]:tw-text-[16px] [&_h6]:tw-leading-[24px] [&_h6]:tw-font-[600]',
      ...
      '[&_blockquote]:tw-relative [&_blockquote]:tw-mt-0 [&_blockquote]:tw-mb-3 [&_blockquote]:tw-mx-0 [&_blockquote]:tw-pl-5 [&_blockquote]:tw-pr-0 [&_blockquote]:tw-py-0 [&_blockquote]:tw-bg-transparent [&_blockquote]:tw-text-[var(--text-primary)] [&_blockquote]:tw-text-[19.2px] [&_blockquote]:tw-leading-[28.8px]',
      ...
      // Notion-like code size: 85% of 16px => 13.6px.
      '[&_code]:tw-px-[5px] [&_code]:tw-py-[1px] [&_code]:tw-rounded-[6px] [&_code]:tw-bg-[color-mix(in_srgb,currentColor_12%,transparent)] [&_code]:tw-font-mono [&_code]:tw-text-[13.6px]',
      '[&_kbd]:tw-inline-flex [&_kbd]:tw-items-center [&_kbd]:tw-rounded-[6px] [&_kbd]:tw-border [&_kbd]:tw-border-[var(--border)] [&_kbd]:tw-bg-[color-mix(in_srgb,var(--bg-sunken)_55%,var(--bg-card))] [&_kbd]:tw-px-[6px] [&_kbd]:tw-py-[1px] [&_kbd]:tw-font-mono [&_kbd]:tw-text-[13.6px]',
      ...
      '[&_pre>code]:tw-block [&_pre>code]:tw-p-0 [&_pre>code]:tw-bg-transparent [&_pre>code]:tw-rounded-none [&_pre>code]:tw-text-[13.6px] [&_pre>code]:tw-leading-[20.4px]',
      ...
      // Notion-like table text: 14px.
      '[&_th]:tw-border [&_th]:tw-border-[var(--border)] [&_th]:tw-px-[6px] [&_th]:tw-py-[4px] [&_th]:tw-align-top [&_th]:tw-text-[14px] [&_th]:tw-leading-[21px] [&_th]:tw-font-[600]',
      '[&_td]:tw-border [&_td]:tw-border-[var(--border)] [&_td]:tw-px-[6px] [&_td]:tw-py-[4px] [&_td]:tw-align-top [&_td]:tw-text-[14px] [&_td]:tw-leading-[21px]',
      ...
      // Notion-like caption: 14px, 1.4 line-height, wrapping.
      '[&_.syncnos-md-image-link]:tw-mt-2 [&_.syncnos-md-image-link]:tw-block [&_.syncnos-md-image-link]:tw-max-w-full [&_.syncnos-md-image-link]:tw-whitespace-normal [&_.syncnos-md-image-link]:tw-text-[14px] [&_.syncnos-md-image-link]:tw-leading-[19.6px] [&_.syncnos-md-image-link]:tw-text-[var(--text-secondary)] [&_.syncnos-md-image-link]:tw-break-words [&_.syncnos-md-image-link]:[overflow-wrap:anywhere]',
