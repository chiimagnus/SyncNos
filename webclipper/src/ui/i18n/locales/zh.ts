...
export const zh: { [K in TranslationKey]: string } = {
  ...
  warningFlagInlineImagesLimitReached: '可内联图片数量超限',
  warningFlagInlineImagesTotalBytesLimitReached: '可内联图片总大小超限',
  ...
  warningFlagInlineImagesSingleTooLarge: '单张图片过大，无法内联',
