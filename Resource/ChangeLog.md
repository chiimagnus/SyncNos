...
- Trial View Animations: Added pulse and shake animations to header icons in onboarding trial view for better user engagement
- Purchase Success Feedback: Display purchase success messages and adjust button visibility based on purchase status

*Changed*

- Trial View Icons: Updated trial view icons and colors to better represent trial and subscription statuses (face.dashed.fill for expired trial)
- Notion Connection Layout: Improved layout and styling of Notion connection view in onboarding process
- VStack Layout: Updated onboarding views to use VStack for improved layout and spacing

## v0.8.4 November 26, 2025

*Added*

- Onboarding Color Assets: Added dedicated color assets for onboarding UI components
- Onboarding Shared Components: Implemented shared components for onboarding flow

*Changed*

- Onboarding Visual Enhancements: Added shadow effect to onboarding header image, improved animations and button design
- Onboarding Layout: Enhanced onboarding view layout and styling for better user experience and clarity

## v0.8.3.3 November 25, 2025

*Changed*

- Documentation: Updated README files with download section improvements

## v0.8.3.2 November 25, 2025

*Added*

- WeRead Auto-Sync: Added WeReadAutoSyncProvider for automated synchronization support
- WeRead Navigation: Enhanced WeRead integration with navigation and caching improvements

*Changed*

- WeRead Session Alert: Updated button label in WeReadListView for session expiration alert
- Documentation: Updated CLAUDE.md to clarify WeRead models and caching services

## v0.8.3.1 November 25, 2025

*Changed*

- Documentation: Updated CLAUDE.md to reflect unified sync engine and architecture changes
- Notion Configuration: Updated Notion configuration file paths and added example file

## v0.8.3 November 25, 2025

*Added*

- WeRead Pagination: Enhanced WeReadDetailViewModel with pagination and loading states support

## v0.8.2.2 November 25, 2025

*Added*

- WeRead Caching: Implemented WeRead caching and incremental sync functionality with SwiftData

*Changed*

- WeRead Thread Safety: Updated WeReadCacheService for thread safety and improved predicate handling

## v0.8.2.1 November 25, 2025

*Changed*

- PayWall Legal Links: Enhanced PayWallView with message display and legal links section
- Privacy Policy: Removed embedded Privacy Policy document, updated to external link in AboutView

## v0.8.2 November 25, 2025

*Added*

- Data Source Toggle: Added data source enable/disable toggle for Apple Books, GoodLinks, and WeRead in settings
- Keyboard Shortcuts: Enhanced data source switching with keyboard shortcuts (⌘1, ⌘2, ⌘3)

*Changed*

- Data Source Management: Implemented data source management in MainListView and ViewCommands
- Onboarding Cleanup: Removed Apple Books path handling from OnboardingViewModel

## v0.8.1 November 24, 2025

*Added*

- Onboarding Flow: Implemented multi-step onboarding flow with Welcome, Notion connection, and data source selection steps
- Onboarding Debug Options: Added debug options and error handling for onboarding flow

*Changed*

- Title Bar: Hidden title bar for main application window
- Onboarding Layout: Simplified OnboardingView layout and transition handling
- Onboarding Steps: Removed Pro Access step from onboarding flow, removed environment detector from OnboardingViewModel
