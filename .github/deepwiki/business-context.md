...
| WebClipper 文章评论 / 注释线程 | WebClipper | 给 article detail 和 inpage comments panel 提供本地 threaded comments | local-first 注释层；article 同步时会进入 Notion / Obsidian 的评论区段，同时继续随 Zip v2 备份 / 导入保留 |
