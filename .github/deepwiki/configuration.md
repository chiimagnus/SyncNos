...
| `manifest.version` | `wxt.config.ts` | `1.5.2` | 商店 workflow 校验的版本事实源 |
...
## 更新记录（Update Notes）
- 2026-04-07：同步本页 `manifest.version` 单一事实源到 `1.5.2`；补齐 `anti_hotlink_rules_v1` 与 `markdown_reading_profile_v1` 的设置/存储说明，并对齐文章抓取的反防盗链图片自动缓存事实。
