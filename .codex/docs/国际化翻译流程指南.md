...
# 步骤 2: 压缩格式（可选，统一风格）
python3 .cursor/scripts/compact_xcstrings.py
...
位置：`.cursor/scripts/compact_xcstrings.py`
...
# 方式 2：指定自定义路径
python3 .cursor/scripts/compact_xcstrings.py path/to/file.xcstrings

# 方式 3：直接执行
./.cursor/scripts/compact_xcstrings.py
```
...
| **格式压缩脚本** | `.cursor/scripts/compact_xcstrings.py` |
