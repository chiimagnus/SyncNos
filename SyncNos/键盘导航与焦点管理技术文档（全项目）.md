...
| `Packages/MenuBarDockKit/Sources/MenuBarDockKit/WindowReader.swift` | SwiftUI ↔ NSWindow 桥接，用于窗口过滤 NSEvent |
...
| `Packages/MenuBarDockKit/Sources/MenuBarDockKit/WindowReader.swift` | 获取 NSWindow |
