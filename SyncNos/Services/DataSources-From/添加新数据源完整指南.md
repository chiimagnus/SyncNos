...
**文件**: `SyncNos/Models/DataSourceProviders/XxxUIProvider.swift`
...
struct XxxUIProvider: DataSourceUIProvider {
    ...
    var accentColor: Color { Color("BrandXxx") }
...
**文件**: `SyncNos/Models/Core/DataSourceRegistry.swift`
...
**文件**: `SyncNos/Services/DataSources-To/Notion/Sync/Adapters/XxxNotionAdapter.swift`
...
| `Resource/Localizable.xcstrings` | 添加本地化字符串 |
