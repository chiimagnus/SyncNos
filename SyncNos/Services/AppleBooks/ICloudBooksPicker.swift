...
/// Allows user to select iCloud Books directory, saves security-scoped bookmark.
/// Usually located at ~/Library/Mobile Documents/iCloud~com~apple~iBooks/Documents
