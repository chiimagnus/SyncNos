...
SyncNos bundles Mozilla's Readability.js to extract readable article content from rendered webpages.

Project: @mozilla/readability
License: Apache-2.0
Upstream: https://github.com/mozilla/readability

The upstream source files in this folder keep their original license headers.
