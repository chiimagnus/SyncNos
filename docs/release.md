...
stable Release 发布后，由 AI 按 [`release-notes-prompt.md`](release-notes-prompt.md) 核对 commits 与 merged PR description，在 Release 顶部同时补充中文与英文的普通用户摘要；不得改写折叠区中的原始 GitHub 变更记录。
