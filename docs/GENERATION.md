...
- `docs/guide/github/GitHubSync.en.md` and `docs/guide/github/GitHubSync.zh.md` are the canonical user setup guides for GitHub App Device Flow, installation scope, repository/branch selection, fixed output folders, Test Connection, sync behavior, and troubleshooting.
